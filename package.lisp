...
(defpackage #:specops
  (:use #:cl)
  (:export #:defcodetable #:make-array-writer #:width-spec #:wspec-name #:wspec-bits
           ...
           #:as-register-file #:deriving-file
           #:assembler #:assembler-encoding #:assembler-masking
           #:asm-name #:asm-extns #:asm-storage #:asm-lexicon
           #:asm-promodel #:asm-reserve #:asm-breadth #:asm-joiner #:asm-exmodes
           ...
           #:extns-of #:derive-promodel #:of-lexicon #:of-decoder #:of-battery #:of-storage
