...
;;     (sib0 (determine-sib op0)) (sib1 (determine-sib op1)))
;;    (:priority                         0      2         1))
;;   ((      #x04                 op1 ) ((:w 1) (:gpr  :a) (:imm    )))
;;   ((      #x05            (w 2 op1)) ((:w 2) (:gpr  :a) (:imm    )))
;;   ((      #x05            (w 4 op1)) ((:w 4) (:gpr  :a) (:imm    )))
;;   ((rex.w #x05            (w 4 op1)) ((:w 8) (:gpr  :a) (:imm    )))
;;   ((      #x80 modz0 sib0      op1 ) ((:w 1) (:gxm    ) (:imm    )))
;;   ((rex   #x80 modz0 sib0      op1 ) ((:w 1) (:gxm    ) (:imm    )))
;;   ((      #x81 modz0 sib0 (w 2 op1)) ((:w 2) (:gxm :lo) (:imm    )))
;;   ((      #x81 modz0 sib0 (w 4 op1)) ((:w 4) (:gxm :lo) (:imm    )))
;;   ((rex.w #x81 modz0 sib0 (w 4 op1)) ((:w 8) (:gxm    ) (:imm    )))
;;   ((      #x83 modz0 sib0      op1 ) ((:w 2) (:gxm :lo) (:imm    )))
;;   ((      #x83 modz0 sib0      op1 ) ((:w 4) (:gxm :lo) (:imm    )))
;;   ((rex.w #x83 modz0 sib0      op1 ) ((:w 8) (:gxm    ) (:imm    )))
;;   ((      #x00 mod10 sib0          ) ((:w 1) (:gxm :lo) (:gpr :lo)))
;;   ((rex   #x00 mod10 sib0          ) ((:w 1) (:gxm    ) (:gpr    )))
;;   ((      #x01 mod10 sib0          ) ((:w 2) (:gxm :lo) (:gpr :lo)))
;;   ((      #x01 mod10 sib0          ) ((:w 4) (:gxm :lo) (:gpr :lo)))
;;   ((rex.w #x01 mod10 sib0          ) ((:w 8) (:gxm    ) (:gpr    )))
;;   ((      #x02 mod01 sib1          ) ((:w 1) (:gpr    ) (:gxm    )))
;;   ((rex   #x02 mod01 sib1          ) ((:w 1) (:gpr    ) (:gxm    )))
;;   ((      #x03 mod01 sib1          ) ((:w 2) (:gpr :lo) (:gxm :lo)))
;;   ((      #x03 mod01 sib1          ) ((:w 4) (:gpr :lo) (:gxm :lo)))
;;   ((rex.w #x03 mod01 sib1          ) ((:w 8) (:gpr    ) (:gxm    ))))

;; (specops add (w op0 op1) *assembler-prototype-x86*
;;   ((:provisions
;;     (rex (determine-pfrex w op0 op1))
;;     (sz? (determine-pfrsize w op0 op1 (of-program :exmode)))
;;     (modz0 (determine-modrm 0 op0))
;;     (mod10 (determine-modrm op1 op0)) (mod01 (determine-modrm op0 op1))
;;     (sib0 (determine-sib op0)) (sib1 (determine-sib op1)))
;;    (:priority                           0      2         1))
;;   ((    rex #x04                 op1 ) ((:w 1) (:gpr :a) (:imm)))
;;   ((sz? rex #x05            (w 2 op1)) ((:w 2) (:gpr :a) (:imm)))
;;   ((sz? rex #x05            (w 4 op1)) ((:w 4) (:gpr :a) (:imm)))
;;   ((    rex #x05            (w 4 op1)) ((:w 8) (:gpr :a) (:imm)))
;;   ;; ((           #x80 modz0 sib0      op1 ) ((:w 1) (:gxm   ) (:imm  )))
;;   ((    rex #x80 modz0 sib0      op1 ) ((:w 1) (:gxm   ) (:imm)))
;;   ((sz? rex #x81 modz0 sib0 (w 2 op1)) ((:w 2) (:gxm   ) (:imm)))
;;   ((sz? rex #x81 modz0 sib0 (w 4 op1)) ((:w 4) (:gxm   ) (:imm)))
;;   ((    rex #x81 modz0 sib0 (w 4 op1)) ((:w 8) (:gxm   ) (:imm)))
;;   ((sz? rex #x83 modz0 sib0      op1 ) ((:w 2) (:gxm   ) (:imm)))
;;   ((sz? rex #x83 modz0 sib0      op1 ) ((:w 4) (:gxm   ) (:imm)))
;;   ((    rex #x83 modz0 sib0      op1 ) ((:w 8) (:gxm   ) (:imm)))
;;   ;; ((           #x00 mod10 sib0          ) ((:w 1) (:gxm   ) (:gpr  )))
;;   ((    rex #x00 mod10 sib0          ) ((:w 1) (:gxm   ) (:gpr)))
;;   ((sz? rex #x01 mod10 sib0          ) ((:w 2) (:gxm   ) (:gpr)))
;;   ((sz? rex #x01 mod10 sib0          ) ((:w 4) (:gxm   ) (:gpr)))
;;   ((    rex #x01 mod10 sib0          ) ((:w 8) (:gxm   ) (:gpr)))
;;   ;; ((           #x02 mod01 sib1          ) ((:w 1) (:gpr   ) (:gxm  )))
;;   ((    rex #x02 mod01 sib1          ) ((:w 1) (:gpr   ) (:gxm)))
;;   ((sz? rex #x03 mod01 sib1          ) ((:w 2) (:gpr   ) (:gxm)))
;;   ((sz? rex #x03 mod01 sib1          ) ((:w 4) (:gpr   ) (:gxm)))
;;   ((    rex #x03 mod01 sib1          ) ((:w 8) (:gpr   ) (:gxm))))
...
;;     (sib0 (determine-sib op0)) (sib1 (determine-sib op1)))
;;    (:priority                       0      2           1))
;;   ((rex #x14                 op1 ) ((:w 1) (:gpr :a) (:imm)))
;;   ((rex #x15            (w 2 op1)) ((:w 2) (:gpr :a) (:imm)))
;;   ((rex #x15            (w 4 op1)) ((:w 4) (:gpr :a) (:imm)))
;;   ((rex #x15            (w 4 op1)) ((:w 8) (:gpr :a) (:imm)))
;;   ;; ((      #x80 mod20 sib0      op1 ) ((:gxm    8) (:imm)))
;;   ((rex #x80 mod20 sib0      op1 ) ((:w 1) (:gxm   ) (:imm)))
;;   ((rex #x81 mod20 sib0 (w 2 op1)) ((:w 2) (:gxm   ) (:imm)))
;;   ((rex #x81 mod20 sib0 (w 4 op1)) ((:w 4) (:gxm   ) (:imm)))
;;   ((rex #x81 mod20 sib0 (w 4 op1)) ((:w 8) (:gxm   ) (:imm)))
;;   ((rex #x83 mod20 sib0      op1 ) ((:w 2) (:gxm   ) (:imm)))
;;   ((rex #x83 mod20 sib0      op1 ) ((:w 4) (:gxm   ) (:imm)))
;;   ((rex #x83 mod20 sib0      op1 ) ((:w 8) (:gxm   ) (:imm)))
;;   ;; ((      #x10 mod10 sib0          ) ((:gxm    8) (:gpr)))
;;   ((rex #x10 mod10 sib0          ) ((:w 1) (:gxm   ) (:gpr)))
;; ((rex #x11 mod10 sib0          ) ((:w 2) (:gxm   ) (:gpr)))
;; ((rex #x11 mod10 sib0          ) ((:w 4) (:gxm   ) (:gpr)))
;; ((rex #x11 mod10 sib0          ) ((:w 8) (:gxm   ) (:gpr)))
;; ;; ((      #x12 mod01 sib1          ) ((:gpr    8) (:gxm)))
;; ((rex #x12 mod01 sib1          ) ((:w 1) (:gpr   ) (:gxm)))
;; ((rex #x13 mod01 sib1          ) ((:w 2) (:gpr   ) (:gxm)))
;; ((rex #x13 mod01 sib1          ) ((:w 4) (:gpr   ) (:gxm)))
;; ((rex #x13 mod01 sib1          ) ((:w 8) (:gpr   ) (:gxm))))
