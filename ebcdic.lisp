...
(defcharset :ebcdic-cp037
  ((:tabular :cross-adding))
  ...
  ((#x30) ()     ()     (:syn) (:ir ) (:pp ) (:trn) (:nbs) (:eot) (:sbs) (:it ) (:rff) (:cu3) (:dc4) (:nak) ()     (:sub))
...
;; (let ((coll)) (dolist (set sets) (loop :for i :in set :when (characterp i) :do (push (char-code i) coll))) (sort coll #'<))
 
(defcharset :ebcdic-cp310 ;; chars over 125 -- select from here
  ((:tabular :cross-adding))
  (_    #x0  #x1  #x2  #x3  #x4  #x5  #x6  #x7  #x8  #x9  #xA  #xB  #xC  #xD  #xE  #xF )
